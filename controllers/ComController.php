...
class ComController extends Controller {
    ...
    public function actionSelectdata($ctid) { // create -> 20102016
//        echo 'Select Data';
//        echo $ctid;
//        die();
      //  $com_type_id=$ctid;
        $com = Com::find()
                //->where('com_type_id=1') //condition
                ->where('com_type_id=:com_type_id',[':com_type_id'=>$ctid]) // conditon แบบ paramitor
                ->all();
//        print_r($com); //check data from aray
        //return $this->render($com);
//        foreach ($com as $value) {
//            //echo $value['brand'].'<br>'; // เข้าถึงข้อมูลในรูปแบบ array
//            echo $value->brand.'<br>'; // เข้าถึงข้อมูลในรูปแบบ object
//        }
