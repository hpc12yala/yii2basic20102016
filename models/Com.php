...
class Com extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'com_id' => 'รหัสคอมฯ',
            'com_type_id' => 'รหัสชนิดคอมฯ',
            'brand' => 'ยี่ห้อ',
            'detail' => 'รายละเอียด',
            'accept_date' => 'วันที่ได้',
            ...
            'price' => 'ราคา',
            'depart_id' => 'รหัสกลุ่ม',
            'com_status_id' => 'รหัสสถานะคอมฯ',
            'com_date' => 'วันที่คอมฯ',
            'insurance_date' => 'ประกันจนถึง',
            'create_date' => 'วันที่เพิ่ม',
            'update_date' => 'วันที่แก้ไข',
            'staff' => 'เจ้าหน้าที่',
            'note' => 'หมายเหตุ',
            'discharge_date' => 'วันที่ส่งคืน',
            'buy_type_id' => 'รหัสชนิดจัดซื้อ',
